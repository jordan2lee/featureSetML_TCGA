...
get_symbols <- function(k){
  ...
  l1 <- list(
    'BRCA_GEXP' = HeatmapAnnotation(highlight_fts = anno_mark(at = c(4,6,12,17,28,31,37,38,43,49,54), labels = symbols[c(4,6,12,17,28,31,37,38,43,49,54)]),annotation_width=unit(1, 'mm'))
  )
  return(l1[[k]])
}
