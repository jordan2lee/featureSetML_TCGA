...
# Set up saving fig packet
setwd(outdir)
pdf(paste('OneMultiNone_ht_', unlist(strsplit(prefix, ':'))[2],'.pdf',sep=''), onefile=FALSE)
draw(fig)
dev.off()
```
...
<details><summary>2. Now grab ONLY the top 5 hallmarks (freq) regardless of % coverage</summary><p>
...
<details><summary>3. Now grab ONLY the top 10 hallmarks (freq) regardless of % coverage </summary><p>
