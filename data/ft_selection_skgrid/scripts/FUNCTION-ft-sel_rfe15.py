...
if MUT_ft_matrix.shape[1] > 0:
    # Run algorithm
    fs.fit(MUT_ft_matrix, y)

    # ALL RESULTS:
    # Get entries to pop dictionary
    list_ranks = fs.ranking_
    list_feature = MUT_ft_matrix.columns
...
if MUT_ft_matrix.shape[1] == 0:
    print('Input matrix Did NOT have any MUTA features')
    MUT_select = [] # create empty list

######################################
# FEATURE SELECTION : CNVR
#####################################
platform = 'CNVR'
print('##### starting CNVR: rfe15 #####')
...
if CNVR_ft_matrix.shape[1] > 0:
    # Run algorithm
    fs.fit(CNVR_ft_matrix, y)

    # ALL RESULTS:
    # Get entries to pop dictionary
    list_ranks = fs.ranking_
    list_feature = CNVR_ft_matrix.columns
    assert len(list_ranks)==len(list_feature)
    # Populate dictionary
    for i in range(0, len(list_ranks)):
        res_dictionary['Feature'][i]= list_feature[i]
...
if CNVR_ft_matrix.shape[1] == 0:
    print('Input matrix Did NOT have any CNVR features')
    CNVR_select = [] # create empty list

######################################
# FEATURE SELECTION : GEXP
#####################################
platform = 'GEXP'
print('##### starting GEXP: rfe15 #####')
...
if GEXP_ft_matrix.shape[1] > 0:
    # Run algorithm
    fs.fit(GEXP_ft_matrix, y)

    # ALL RESULTS:
    # Get entries to pop dictionary
    list_ranks = fs.ranking_
    list_feature = GEXP_ft_matrix.columns
    assert len(list_ranks)==len(list_feature)
    # Populate dictionary
    for i in range(0, len(list_ranks)):
        res_dictionary['Feature'][i]= list_feature[i]
...
if GEXP_ft_matrix.shape[1] == 0:
    print('Input matrix Did NOT have any GEXP features')
    GEXP_select = [] # create empty list
...
if MET_ft_matrix.shape[1] > 0:
    # Run algorithm
    fs.fit(MET_ft_matrix, y)

    # ALL RESULTS:
    # Get entries to pop dictionary
    list_ranks = fs.ranking_
    list_feature = MET_ft_matrix.columns
    assert len(list_ranks)==len(list_feature)
    # Populate dictionary
    for i in range(0, len(list_ranks)):
        res_dictionary['Feature'][i]= list_feature[i]
...
if MET_ft_matrix.shape[1] == 0:
    print('Input matrix Did NOT have any MET features')
    MET_select = [] # create empty list
...
if MI_ft_matrix.shape[1] > 0:
    # Run algorithm
    fs.fit(MI_ft_matrix, y)

    # ALL RESULTS:
    # Get entries to pop dictionary
    list_ranks = fs.ranking_
    list_feature = MI_ft_matrix.columns
    assert len(list_ranks)==len(list_feature)
    # Populate dictionary
    for i in range(0, len(list_ranks)):
        res_dictionary['Feature'][i]= list_feature[i]
...
if MI_ft_matrix.shape[1] == 0:
    print('Input matrix Did NOT have any MI features')
    MI_select = [] # create empty list
...
summary.to_csv(op+out_name, sep="\t", index = False)
